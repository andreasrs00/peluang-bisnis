<nav x-data="{ open: false }" class="bg-white border-b border-brand-neutral">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="inline-flex items-center gap-2">
                        ...
                        <span class="hidden sm:inline font-black tracking-tight text-gray-900">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center gap-2 px-3 py-2 rounded-lg
                                       ...
                                       hover:border-brand-primary/40 hover:text-gray-900
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-3 border-t border-brand-neutral">
            <div class="px-4">
